...
<Grid container spacing={2} sx={{ p: 2, bgcolor: 'white' }}>
  <Grid item xs={12}>
    <FormControl fullWidth sx={{ mb: 2 }}>
      <InputLabel htmlFor="tarefa_titulo" sx={{ fontSize: 16, fontWeight: 500 }}>Título da Tarefa</InputLabel>
      <Input id="tarefa_titulo" aria-describedby="tarefa_titulo_helper_text" value={tituloTarefa} onChange={e => { setTituloTarefa(e.target.value) }} sx={{ fontSize: 16, padding: '10px 12px' }} />
      <FormHelperText id="tarefa_titulo_helper_text" sx={{ fontSize: 14, color: 'gray' }}>Título da Tarefa</FormHelperText>
    </FormControl>
  </Grid>
  <Grid item xs={12}>
    <FormControl fullWidth sx={{ mb: 2 }}>
      <InputLabel htmlFor="tarefa_descricao" sx={{ fontSize: 16, fontWeight: 500 }}>Descrição da Tarefa</InputLabel>
      <Input id="tarefa_descricao" aria-describedby="tarefa_descricao_helper_text" value={descricaoTarefa} onChange={e => { setDescricaoTarefa(e.target.value) }} sx={{ fontSize: 16, padding: '10px 12px' }} />
      <FormHelperText id="tarefa_descricao_helper_text" sx={{ fontSize: 14, color: 'gray' }}>Descrição da Tarefa</FormHelperText>
    </FormControl>
  </Grid>
  <Grid container spacing={2} sx={{ mt: 2 }}>
    <Grid item xs={3}>
      <FormControl fullWidth sx={{ mb: 2 }}>
        <InputLabel htmlFor="tarefa_inicio" sx={{ fontSize: 16, fontWeight: 500 }}>Início da Tarefa</InputLabel>
        <Input id="tarefa_inicio" type="date" aria-describedby="tarefa_inicio_helper_text" value={inicioTarefa} onChange={e => { setInicioTarefa(e.target.value) }} sx={{ fontSize: 16, padding: '10px 12px' }} />
        <FormHelperText id="tarefa_inicio_helper_text" sx={{ fontSize: 14, color: 'gray' }}>Início da Tarefa</FormHelperText>
      </FormControl>
    </Grid>
    <Grid item xs={3}>
      <FormControl fullWidth sx={{ mb: 2 }}>
        <InputLabel htmlFor="tarefa_fim" sx={{ fontSize: 16, fontWeight: 500 }}>Fim da Tarefa</InputLabel>
        <Input id="tarefa_fim" type="date" aria-describedby="tarefa_fim_helper_text" value={fimTarefa} onChange={e => { setFimTarefa(e.target.value) }} sx={{ fontSize: 16, padding: '10px 12px' }} />
        <FormHelperText id="tarefa_fim_helper_text" sx={{ fontSize: 14, color: 'gray' }}>Fim da Tarefa</FormHelperText>
      </FormControl>
    </Grid>
  </Grid>
</Grid>
